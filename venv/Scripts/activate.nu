...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Niko Novak\Desktop\FastFood-App\ffa-backend\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Niko Novak\Desktop\FastFood-App\ffa-backend\venv\Scripts\deactivate.nu'
